...
class AnalyzerSetUpTest(unittest.TestCase):
    ...
    def test_valid_filepath_argument(self):
        jack_path = Path(os.path.join(PROJ_10_DIR, "Square/Square.jack"))
